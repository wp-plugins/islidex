...
We will add this in version 2.0.
For now you can use the custom fields `islidex_slide` and `islidex_thumb` with the full link to the image, to achieve the same purpose.
...
= Can I change the effects of the Nivo Slider style? =
