...
* *`<?php show_islidex(); ?>`* or *[php]show_islidex()[/php]* if you use also the plugin [PHP Shortcode](http://wordpress.org/extend/plugins/php-shortcode).

= Pages =

* *[islidex_page]* (it will show on top of the page content)
* *`<?php show_islidexpage(); ?>`* or *[php]show_islidex()[/php]* if you use also the plugin [PHP Shortcode](http://wordpress.org/extend/plugins/php-shortcode).
