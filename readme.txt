...
* `<?php if (function_exists('show_customislidex')) { show_customislidex('3,1','3','450','200'); } ?>`, to use directly inside the template code
* `[php]if (function_exists('show_customislidex')) { show_customislidex('3,1','3','450','200'); }[/php]` to use in the content, if you use also the plugin [PHP Shortcode](http://wordpress.org/extend/plugins/php-shortcode)
