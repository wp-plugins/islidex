...
<div class="islidex_options-body">
  ...
  <table class="form-table">
    ...
    <tr valign="top">
      ...
      <td>
		<?php $themename = array('Apple', 'Nivo', 'Piecemaker', 'Timeline');
...
<div class="islidex_options-body widget">
  ...
  <table class="form-table">
    ...
    <tr valign="top">
      ...
      <td>
		<?php $wthemename = array('Apple', 'Nivo', 'Timeline');
...
<!-- Other -->
	...
	<div class="islidex_options-body support usage admin-info">
		...
		If you want to use it directly in the template code, use <code>&lt;?php show_customislidex(5,3,450,200,1); ?&gt;</code>.
		<br />
		The numbers 5, 3, 450, 200, 1 are only an example here, you must change them depending on the values you prefer.
		<br />These numbers represent, in order: <strong>cat</strong>egory (where to get the posts from), max <strong>num</strong>ber of posts/slides (to show in iSlidex), <strong>w</strong>idth (of the slider), <strong>h</strong>eight (of the slider), <strong>theme</strong> (1 is Apple, 2 is Nivo, 3 is Piecemaker). Please replace the numbers with the settings you prefer, each time you want to add a new slider in a different location.
		The paramater <code>cat=</code> can take also multiple categories, separated by comma. Just type for example <code>cat=3,5</code>.
		</p>
	</div>
