...
<div class="wrap">
	...
	<br />
	<strong>&lt;?php if (function_exists('show_customislidex')) { show_customislidex('3','3','450','200'); } ?&gt</strong>, to use directly inside the template code
	<br />
	<strong>[php]if (function_exists('show_customislidex')) { show_customislidex('3','3','450','200'); }[/php]</strong> to use in the content, if you use also the plugin <a href="http://wordpress.org/extend/plugins/php-shortcode" target="_blank">PHP Shortcode</a>.
	<br />
	The numbers 3, 3, 450, 200 are only an example here, and represent in order: category (where to get the posts from), max number of posts/slides (to get from that category), width (of the slider), height (of the slider). Please replace them with the settings you prefer, each time you want to add a new slider in a different location.
	</div>
