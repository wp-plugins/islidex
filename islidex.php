...
// NEED OF ANOTHER POST/PAGE FUNCTION, AS IN SOME CASES THE PREVIOUS ONES WONT WORK
...
// And here's the shortcode for it - USE IT ONLY if the normal ones doesnt work

add_shortcode('islidex_special', 'show_special');