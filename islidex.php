...
function show_islidex() {
	...
	<div class="mypiecemaker" style="width:<?php ($islidex_options['slide_size_w']+80) ?>px;height:<?php ($islidex_options['slide_size_h']+150) ?>px;vertical-align:middle;text-align:center;margin:0;padding-top:25px;valign:middle;align:middle;display:block;">
	<div id="flashcontent">
