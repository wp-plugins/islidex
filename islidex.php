...
Description: Apple-style slideshow for Wordpress. Settings and documentation are under Plugin -> iSlidex. Official plugin page <a href="http://www.shambix.com/en/news/wordpress-plugin-islidex/">here</a>. Based on a <a href="http://tutorialzine.com/2009/11/beautiful-apple-gallery-slideshow/">TutorialZine</a> script. Credits to Brian Reavis for <a href="http://thirdroute.com/projects/captify">Captify</a>.
Version: 1.7
Author: Shambix
...
function islidexjs() {
		...
		$islidex_options = get_option('islidex_options');
		if ($islidex_options['use_caption'] == 1) {
...
setup_postdata($post);
	...
	echo '<div class="slide"><a href="'.get_permalink($post).'" title="'.$clean_title.'"><img width="'.$islidex_options['slide_size_w'].'" height="'.$islidex_options['slide_size_h'].'" src="'.$timthumb_path.'?src='.$slide.'&w='.$islidex_options['slide_size_w'].'&h='.$islidex_options['slide_size_h'].'&zc=1&q=100" alt="'.$clean_title.'" class="captify" /></a></div>';
	...
	$img = wp_get_attachment_image_src($id, 'full');
	$img_url = parse_url($img[0], PHP_URL_PATH);
	print '<div class="slide"><a href="'.get_permalink($post).'" title="'.$clean_title.'"><img width="'.$islidex_options['slide_size_w'].'" height="'.$islidex_options['slide_size_h'].'" src="'.$timthumb_path.'?src='.$img_url.'&w='.$islidex_options['slide_size_w'].'&h='.$islidex_options['slide_size_h'].'&zc=1&q=100" alt="'.$clean_title.'" class="captify" /></a></div>'; 
...
$timthumb_path = ISLIDEX_PLUGIN_JS . '/timthumb.php';
	...
	echo '<div class="slide"><img width="'.$islidex_options['widget_size_w'].'" height="'.$islidex_options['widget_size_h'].'" src="'.$timthumb_path.'?src='.$slide.'&w='.$islidex_options['widget_size_h'].'&h='.$islidex_options['slide_size_h'].'&zc=1&q=100" alt="'.$clean_title.'" class="captify" /></div>';
	...
	$img = wp_get_attachment_image_src($id, 'full');
	$img_url = parse_url($img[0], PHP_URL_PATH);
	print '<div class="slide"><img width="'.$islidex_options['widget_size_w'].'" height="'.$islidex_options['widget_size_h'].'" src="'.$timthumb_path.'?src='.$img_url.'&w='.$islidex_options['widget_size_h'].'&h='.$islidex_options['slide_size_h'].'&zc=1&q=100" alt="'.$clean_title.'" class="captify" /></div>'; 
...
setup_postdata($post);
	...
	echo '<div class="slide"><img width="'.$islidex_options['widget_size_w'].'" height="'.$islidex_options['widget_size_h'].'" src="'.$timthumb_path.'?src='.$slide.'&w='.$islidex_options['widget_size_w'].'&h='.$islidex_options['widget_size_h'].'&zc=1&q=100" alt="'.$clean_title.'" class="captify" /></div>';
	...
	$img = wp_get_attachment_image_src($id, 'full');
	$img_url = parse_url($img[0], PHP_URL_PATH);
	print '<div class="slide"><img width="'.$islidex_options['widget_size_w'].'" height="'.$islidex_options['widget_size_h'].'" src="'.$timthumb_path.'?src='.$img_url.'&w='.$islidex_options['widget_size_w'].'&h='.$islidex_options['widget_size_h'].'&zc=1&q=100" alt="'.$clean_title.'" class="captify" /></div>'; 
...
global $post;
	...
	echo '<div class="slide"><a href="'.get_permalink($post).'" title="'.$clean_title.'"><img width="'.$width.'" height="'.$height.'" src="'.$timthumb_path.'?src='.$slide.'&w='.$width.'&h='.$height.'&zc=1&q=100" alt="'.$clean_title.'" class="captify" /></a></div>';
	...
	$img = wp_get_attachment_image_src($id, 'full');
	$img_url = parse_url($img[0], PHP_URL_PATH);
	print '<div class="slide"><a href="'.get_permalink($post).'" title="'.$clean_title.'"><img width="'.$width.'" height="'.$height.'" src="'.$timthumb_path.'?src='.$img_url.'&w='.$width.'&h='.$height.'&zc=1&q=100" alt="'.$clean_title.'" class="captify" /></a></div>'; 
...
setup_postdata($post);
	...
	echo '<div class="slide"><a href="'.get_permalink($post).'" title="'.$clean_title.'"><img width="'.$islidex_options['slide_size_w'].'" height="'.$islidex_options['slide_size_h'].'" src="'.$timthumb_path.'?src='.$timthumb_path2.''.$slide.'&w='.$islidex_options['slide_size_w'].'&h='.$islidex_options['slide_size_h'].'&zc=1&q=100" alt="'.$clean_title.'" class="captify" /></a></div>';
	...
	$img = wp_get_attachment_image_src($id, 'full');
	$img_url = parse_url($img[0], PHP_URL_PATH);
	print '<div class="slide"><a href="'.get_permalink($post).'" title="'.$clean_title.'"><img width="'.$islidex_options['slide_size_w'].'" height="'.$islidex_options['slide_size_h'].'" src="'.$timthumb_path.'?src='.$timthumb_path2.''.$img_url.'&w='.$islidex_options['slide_size_w'].'&h='.$islidex_options['slide_size_h'].'&zc=1&q=100" alt="'.$clean_title.'" class="captify" /></a></div>'; 
