...
<div class="wrap">
	...
	<br />
	To customize exactly what slide/thumb to show add the custom fields `islidex_slide` and <strong>islidex_thumb</strong> + the direct link to the images.
	<br /><br />
	<strong>= Posts =</strong>
	<br />
	Use these:
...
global $post;
	...
	echo '<div class="slide"><a href="'.get_permalink($post).'" title="'.$post->post_title.'"><img width="'.$width.'" height="'.$height.'" src="'.$timthumb_path.'?src='.$slide.'&w='.$width.'&h='.$height.'&zc=1&q=100" alt="'.$post->post_title.'" /></a></div>';
